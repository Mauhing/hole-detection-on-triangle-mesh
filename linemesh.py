"""
Source: https://github.com/isl-org/Open3D/pull/738#issuecomment-564785941
...
class LineMesh(object):
    ...
    def create_line_mesh(self):
        ...
        for i in range(line_segments_unit.shape[0]):
            ...
            #print("self.colors.ndim: ", self.colors.ndim)
...
def main():
    ...
    points = np.array(points) + [0, 2, 0]
    lines3 = LineMesh.lines_from_ordered_points(points)
